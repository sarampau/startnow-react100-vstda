...
describe('Very Simple To Do App', function main() {
  ...
  it('should add todo item with priority', () =>
    nightmare
      ...
      .wait(500)
      .evaluate(() => {
        const { innerText, className } = document.querySelectorAll('.list-item')[0];
  ...
  it('should allow to edit a todo item by clicking .edit-todo of a todo element', () =>
    nightmare
      ...
      .click('.update-todo')
      .evaluate(() => document.querySelectorAll('.list-item')[0].innerText)
      .end()
  ...
  it('should allow to delete a todo item by clicking .delete-todo of a todo element', () =>
    nightmare
      ...
      .click('.delete-todo')
      .wait(250)
      .evaluate(() => document.querySelectorAll('.list-item').length)
      .end()
